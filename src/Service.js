...
export function showProductosInicio(){
    if (productos != null){
        fin=6;
        let productosIni = productos.slice(ini,fin);
        return productosIni;
    }
};

export function buttonMasProductos(){
    if(productos.length>fin){
        return true;
    }
    else{
        return null;
